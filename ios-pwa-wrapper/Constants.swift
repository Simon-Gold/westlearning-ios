...
let appTitle = "Westnetmlp"
let webAppUrl = URL(string: "https://develaws.westnetmlp.com")
let allowedOrigin = "west"
...
let navigationBarColor = getColorFromHex(hex: 0x3c84ad, alpha: 1.0)
